...
export default class ProductForm {
  ...
  onLoadImage = () => {
    ...
    fileInput.onchange = async () => {
      ...
      if (file) {
        ...
        this.subElements.imageListContainer.firstElementChild.append(this.getImageTemplate(result.data.link, file.name));
    ...
    <form data-element="productForm" class="form-grid">
      <div class="form-group form-group__half_left">
        <fieldset>
          ...
          <input required="" type="text" id="name" name="title" class="form-control" placeholder="Название товара">
        </fieldset>
      </div>
  ...
  async render () {
    ...
    if(this.formData) {
      this.setForm();
      this.createSortableListOfImages();
  ...
  initEventListeners() {
    ...
    this.subElements.uploadImage.addEventListener('click', this.onLoadImage);
  }
  ...
  createSortableListOfImages() {
    const items = this.formData.images.map(image => this.getImageTemplate(image.url, image.source));
